...
//         <div className=" pl-20   m-4 p-4 w-[500px]  text-black text-center">
 
//  <h2 className="text-2xl font-semibold mb-8">Query Form</h2>
//         <form className=''>
//           <div className="mb-5 flex gap-5">
//             <label className="block text-sm">Name</label>
//             <input type="text" className="w-40 h-7 border-2 rounded p-2" />
//           </div>
//           <div className="mb-2">
...
//             <select className="w-40  border-2 rounded p-2">
//               <option className='' value=" ">Select a city</option>
...
//         </form>
//       </div>
//       <div className='hidden md:lg:block w-[600px] h-[400px] '>
//         <img 
//         src='/image/Repair/Rquery/bgq.svg'/>
  ...
  // Contactinfo component
    ...
    return (
      <div className='p-6 bg-gray-100 w-full'>
        ...
        <div className='flex flex-col md:flex-row justify-between px-2 md:lg:px-6 py-6'>
          <div className='flex-1 mb-6 md:mb-0 md:mr-6'>
            <h3 className='text-2xl md:lg:text-6xl font-semibold mb-4 px-4'>Join us in creating a shining brand for you!</h3>
          </div>
          <div className='flex-1 px-4'>
            <p className='mt-2 md:lg:mt-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore incidunt sit totam et ut esse explicabo rerum quos, doloribus mollitia perspiciatis necessitatibus ipsum tempora veniam?</p>
          </div>
        </div>
        <div className="px-4  md:lg:py-8 w-full">
